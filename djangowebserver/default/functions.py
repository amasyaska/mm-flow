...
def calculate_costs(model1, model2, model3, model4, wl_pow, rf_pow, se_pow, months,
    ...
    return {'Survey': survey_cost,
            'Transportation': transportation_cost,
            'Antenna installation/replacement': antenna_cost,
            'Equipment installation BBU+RRU(up to 3)': equip_bbu_rru_cost,
            'Equipment installation RRU(up to 3)': equip_rru_3_cost,
            'Equipment installation RRU(up to 6)': equip_rru_6_cost,
